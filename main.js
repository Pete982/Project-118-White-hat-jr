...
array1W = quick_draw_data_set[random_no];

document.getElementById("Sketch").innerHTML = "Your Sketch that's being drawn: "+array1W;
...
function check_sketch(){
   ...
   document.getElementById("timer").innerHTML = "The Coded Timer:"+timer_counter;
...
function updateCanvas(){
   ...
   array1W = quick_draw_data_set[random_no];
   random_no = Math.floor((Math.round()*quick_draw_data_set)+1);
}
